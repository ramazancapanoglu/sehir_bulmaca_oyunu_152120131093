...
private Button[] butonlar;
	...
	private static final String[] iller = new String[] {"ISPARTA","KONYA","ANKARA","ÝSTANBUL","ADANA","ÝZMÝR","EDÝRNE","KOCAELÝ","BURSA","MANÝSA","KÜTAHYA","AYDIN","MUÐLA",
		"DENÝZLÝ","BURDUR","ANTALYA","KARAMAN","HATAY","KAYSERÝ","SÝVAS","BOLU","DÜZCE","KARABÜK","ÇORUM","AMASYA","TOKAT","ÇANKIRI","ORDU","GÝRESUN","YOZGAT","ERZÝNCAN","SÝVAS",
		"TRABZON","ERZURUM","KARS","AÐRI","BÝNGÖL","MUÞ","BÝTLÝS"};
	char[] rasgeleHarf = new char[]{'A','B','C','Ç','D','E','F','G','H','I','Ý','J','K','L','M','N','O','Ö','P','R','S','Þ','T','U','Ü','V','Y','Z'};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (sorusayisi == 11) {
					sureyidurdur=true;
					dlgAlert.setTitle("Puanýnýz : " + (dogrucevapsayisi*10) ); 
		...
		Timer tmrBlink = new Timer(500, new Runnable() { 
            ...
            public void run() { 
              ...
              { 
            	  sure--;
            	  txt_sure.setText("Süre : " + sure);
              } 
              if (sure==0) {
				durum.setText("Süreniz Doldu!!");
				for (int i = 0; i < 9; i++) {
